          ...
          <div className="bg-blue-50/50 rounded-[60px] p-12 md:p-20 shadow-inner overflow-hidden border border-blue-100">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <input type="text" placeholder="성함" className="bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none transition-all shadow-sm focus:ring-2 focus:ring-primary/20" />
                <input type="text" placeholder="희망 지역" className="bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none transition-all shadow-sm focus:ring-2 focus:ring-primary/20" />
              </div>
              <input type="tel" placeholder="연락처" className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 outline-none transition-all shadow-sm focus:ring-2 focus:ring-primary/20" />
              <textarea placeholder="문의 내용" className="w-full bg-white border border-gray-200 rounded-2xl px-6 py-4 h-40 outline-none resize-none transition-all shadow-sm focus:ring-2 focus:ring-primary/20"></textarea>
              <button className="w-full bg-primary text-white font-black py-6 rounded-2xl text-xl hover:bg-blue-700 shadow-2xl shadow-blue-200 transition-all active:scale-[0.98]">무료 창업 상담 예약하기</button>
            </form>
          </div>
        </div>
      </section>
