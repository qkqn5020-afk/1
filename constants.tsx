...
export const FAQ_LIST: FAQItem[] = [
  {
    ...
    answer: "네, 가능합니다. 베카24는 야구 전문 지식이나 매장 운영 경험이 없어도 운영할 수 있도록 무인 시스템과 표준화된 운영 구조로 설계되었습니다. 본사에서 초기 세팅과 운영 가이드를 제공합니다."
  },
  {
    question: "상주 직원 없이도 매장 운영이 정말 가능한가요?",
    answer: "가능합니다. 베카24는 자동 결제, 무인 출입, 원격 관리 시스템을 통해 상주 인력 없이 운영이 가능합니다. 점주는 매장 상황을 비대면으로 확인하고 관리할 수 있습니다."
  },
  {
  ...
  },
  {
    ...
    answer: "베카24는 야구 체험 콘텐츠 이용료와 음료·부가 상품 판매를 통한 복합 매출 구조를 가지고 있어, 단일 수익원 대비 안정적인 운영이 가능합니다."
  },
  {
  ...
  },
  {
    ...
    answer: "베카24는 업종 특성에 맞는 상권 분석과 입지 컨설팅을 통해 점주의 창업 리스크를 줄이는 방향으로 지원합니다."
  }
];
